...
ENV GOPATH /go
WORKDIR /go/src/github.com/tutumcloud/dockercloud-agent
ADD . /go/src/github.com/tutumcloud/dockercloud-agent
RUN go get -d -v && go build -v

CMD ["/go/src/github.com/tutumcloud/dockercloud-agent"]
